...
namespace MinimalApis.Data
{
    public class DbInitializer
    {
        ...
        private static List<OrderTopping> ingredientsListOne =
             new()
             {
                 new OrderTopping { Id = 1, WaffleId = 1, Name = "Vanilla icecream", Price = 2M },
                 new OrderTopping { Id = 5, WaffleId = 1, Name = "Chocolate sauce",  Price = 1M },
                 new OrderTopping { Id = 7, WaffleId = 1, Name = "Fresh bananas",  Price = 2.5M }
             };
        private static List<OrderTopping> ingredientsListTwo =
            new()
            {
                new OrderTopping { Id = 11, WaffleId = 2, Name = "Cheddar cheese",  Price = 3M },
                new OrderTopping { Id = 13, WaffleId = 2, Name = "Bacon",  Price = 4M },
            };
        private static List<OrderTopping> ingredientsListThree =
             new()
             {
                 new OrderTopping { Id = 11, WaffleId = 3, Name = "Cheddar cheese", Price = 3M },
                 new OrderTopping { Id = 13, WaffleId = 3, Name = "Bacon",  Price = 4M },
             };
